...
int main() {
    ...
    cv::Mat left = cv::imread(left_file, CV_8U);
    cv::Mat right = cv::imread(right_file, CV_8U);
    ...
    disparity_sgbm.convertTo(disparity, CV_32F, 1.0 / 16.0f); // real number in 0 and 96
